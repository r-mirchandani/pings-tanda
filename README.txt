...
While I am familiar with Python and SQL, using them with a live web server was not something that I had ever done before. This implementation was done over ~3 days, the bulk of which was spent learning the in's and out's of Flask and HTTP requests. I found this to be a really great learning experience, so even if my implementation isn't the best one you recieve, it would be great to get some feedback on my work.